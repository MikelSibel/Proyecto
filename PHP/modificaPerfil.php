...
$consultaAlumno = $conexion->prepare("SELECT Nombre, Apellido_1, Apellido_2, Tel, Estado FROM ALUMNOS WHERE Nombre_User = ?");
...
if (!$esAlumno) 
{
    $consultaProfesor = $conexion->prepare("SELECT Nombre, Apellido_1, Apellido_2, Tel FROM PROFESORES WHERE Nombre_User = ?");
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <form action="actualizaPerfil.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <a href="/Proyecto/PHP/perfil.php" class="btn btn-secondary">Volver</a>
